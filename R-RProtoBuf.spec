...
Version  : 0.4.23
Release  : 56
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/RProtoBuf_0.4.23.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/RProtoBuf_0.4.23.tar.gz
...
%setup -q -n RProtoBuf
pushd ..
cp -a RProtoBuf buildavx2
popd
pushd ..
cp -a RProtoBuf buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736948805
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/RProtoBuf/libs/RProtoBuf.so
/V4/usr/lib64/R/library/RProtoBuf/libs/RProtoBuf.so
